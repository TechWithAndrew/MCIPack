...
bool face_lighting_check(int inputAlpha) {
    ...
    if (inputAlpha == 254) return false; // Checks for alpha 254, and returns that this face should not be lit.
	if (inputAlpha == 252) return false; // Checks for alpha 252, and returns that this face should not be lit.
	if (inputAlpha == 251) return true; // Checks for alpha 252, and returns that this face should not be lit.
    if (inputAlpha == 250) return false; // Used in the example pack for lime concrete.
	if (inputAlpha == 245) return false;
	if (inputAlpha == 218) return false;
	if (inputAlpha == 192) return false;
	if (inputAlpha == 164) return false;
	if (inputAlpha == 139) return false;
	if (inputAlpha == 113) return false;
	if (inputAlpha == 89) return false;
	if (inputAlpha == 66) return false;
	if (inputAlpha == 45) return false;
	if (inputAlpha == 26) return false;
...
float remap_alpha(int inputAlpha) {
    ...
    if (inputAlpha == 254) return 255.0; // Checks for alpha 252 and converts all pixels of that to alpha 255. Used in the example pack for redstone ore and the zombie's eyes.
    if (inputAlpha == 252) return 180.0; // You can copy & paste this line and change the values to make any transparent block work with this pack. Used in the example pack for ice.
	if (inputAlpha == 251) return 255.0;
    if (inputAlpha == 250) return 255.0; // Used in the example pack for lime concrete.
	if (inputAlpha == 245) return 245.0;
	if (inputAlpha == 218) return 218.0;
	if (inputAlpha == 192) return 192.0;
	if (inputAlpha == 164) return 164.0;
	if (inputAlpha == 139) return 139.0;
	if (inputAlpha == 113) return 113.0;
	if (inputAlpha == 89) return 89.0;
	if (inputAlpha == 66) return 66.0;
	if (inputAlpha == 45) return 45.0;
	if (inputAlpha == 26) return 26.0;
...
vec4 make_emissive(vec4 inputColor, vec4 lightColor, vec4 faceLightColor, int inputAlpha) {
    ...
    if (inputAlpha == 254) return inputColor; // Checks for alpha 254 and just returns the input color if it is.
	if (inputAlpha == 252) return inputColor; // Checks for alpha 252 and just returns the input color if it is.
	if (inputAlpha == 251) return inputColor; // Checks for alpha 251 and just returns the input color if it is.
    if (inputAlpha == 250) return apply_partial_emissivity(inputColor, lightColor, vec3(0.411, 0.345, 0.388)); // Used in the example pack for ice.
	if (inputAlpha == 245) return inputColor;
	if (inputAlpha == 218) return inputColor;
	if (inputAlpha == 192) return inputColor;
	if (inputAlpha == 164) return inputColor;
	if (inputAlpha == 139) return inputColor;
	if (inputAlpha == 113) return inputColor;
	if (inputAlpha == 89) return inputColor;
	if (inputAlpha == 66) return inputColor;
	if (inputAlpha == 45) return inputColor;
	if (inputAlpha == 26) return inputColor;
